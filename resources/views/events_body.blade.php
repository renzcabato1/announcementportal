<div class='events_body' id ='events_body'>
    <div class='row header_events ' style='background-color:#fffbea;border-bottom-left-radius:40%;border-bottom-right-radius:40%;'>
        ...
        <div class='col-7 profile_header'>
            <img src="{{asset('images/no_image.png')}}" class='rounded-circle  profile_h'  >
    ...
    <div class='row events_bottom'>
        <div class='col-3 vl_events  events_spacing' style='margin-left:20px;'>
            <p class='events_text'><b>FORUM</b> <a href="#"  title='New Forum' data-toggle="modal" data-target="#new_forum" > 
                <span class="glyphicon glyphicon-plus" style='color:darkgreen;font-size:50%;'>New</span>
            </a>	
        ...
        <div class="a">
            <span class='events_text_inside'>{{$forum->title}}
                ...
                @if($forum->add_by == auth()->user()->id)
                <a href='remove-forum/{{$forum->id}}' onclick='show()' title='remove'><span  class="glyphicon glyphicon-remove" style="color:red;font-size:50%;">Remove</span></a>
                @endif
            </span><br>
    ...
    <div class='col-3 vl_events'>
        ...
        <div class="a">
            <span class='events_text_inside'>Title: {{$event->title}}
                ...
                @if($event->add_by == auth()->user()->id)
                <a href='remove-event/{{$event->id}}' onclick='show()' title='remove'><span  class="glyphicon glyphicon-remove" style="color:red;font-size:50%;">Remove</span></a>
                @endif
            </span><br>
    ...
    <div class='col-3 vl_events'>
        <p class='events_text'><b>POLLS</b> <a href="#"  title='New Polls' data-toggle="modal" data-target="#new_polls" > 
            <span class="glyphicon glyphicon-plus" style='color:darkgreen;font-size:50%;'>New</span>
        </a>	
    ...
    <div class="a">
        <span class='events_text_inside'>Title: {{$poll->title}}
            ...
            <a href='remove-poll/{{$poll->id}}' onclick='show()' title='remove'><span  class="glyphicon glyphicon-remove" style="color:red;font-size:50%;">Remove</span></a>
            @endif
        </span><br>
...
<div class='footer company_a ' >
    <div class='container'>
        <div class='row justify-content-md-center' style='margin:0px;margin-top:7px; '>
            <span class='company' >La Filipina Uy Gongco Group of Companies &nbsp;
                <a href="{{ route('logout') }}"  onclick="logout(); show();" >
                    <span class="caption" style='border-left:1px solid #fff;'> &nbsp; Log Out
                    </span>
                </a>
                @if(Auth::user())
