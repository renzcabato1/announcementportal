<div class='bulletin_body' id='bulletin_body'>
	...
	<div class='row bulletin_bottom '>
		...
		@if(session()->has('status_description'))<span style='color:green;font-size:150%;' class="label label-success"> {{session()->get('status_description')}}</span>@endif
		<br>
		<p class='carosel_text'><a href='#' title='edit' data-toggle="modal" data-target="#edit_description" ><span  class="glyphicon glyphicon-edit " style="color:red;font-size:100%;">Edit</span></a>{{$slideshow->description}}</p>
		...
		<div class='col-md-3 bulletin'>
			...
			<div class='bulletin_files'>
				...
				<div class='bulleting_spacing '>
					...
					@if($bulletin->add_by == auth()->user()->id)
					<a href='remove-bulletin/{{$bulletin->id}}' onclick='show()' title='remove'><span  class="glyphicon glyphicon-remove" style="color:red;font-size:100%;">Delete</span></a>
					@endif
